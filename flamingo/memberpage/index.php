...
<div>
    ...
    <div class="l-header-inner clearfix">
        <div class="header-logo">
            <a href="sample.php">
                <img width="50px" height="30px" src="../images/images.png" alt="online英会話ロゴ">
            </a>
        </div>
        ...
        <nav class="header-nav">
            <ul>
                <li><a href="index.php" title="">TOP</a></li>
                <li><a href="message.php" title="">メッセージ</a></li>
                <li><a href="profile/index.php" title="">プロフィール</a></li>
                <li><a href="help.php" title="">ヘルプ</a></li>
                <li><a href="../index.php" title="">ログアウト</a></li>
                <li><a style="border-radius:50%;border:2px solid #c4c4c4; padding:0;"><img width="28px" height="28px" src="" alt=""></a></li>
            </ul>
        </nav>
    </div>
</header><!-- /header -->
    <main class="l-all-contents">
        ...
        <div class="mentor-list">
            <div class="mentor" style="width:200px; height: 300px; float:left; margin:15px; background-color:pink;">
                <img src="" alt="mentor" style="background-color:yellow;padding:0;margin:0;width:100%;height:200px;">
                <div class="mentor-name" style="width:100%;height:20px;padding:0;margin:0;background-color:green">
                    <p style="margin:0;padding:0;">name</p>
                </div>
                <div class="mentor-comment" style="background-color:blue; padding:0;margin:0;width:100%;height:80px;">
                    <p>comment</p>
                </div>
            </div>
        </div>
